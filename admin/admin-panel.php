<div class="wrap wpcf7">
	...
	<li class="addnew"><a href="<?php echo $base_url . '?page=' . $page . '&contactform=new'; ?>"<?php if ( $unsaved ) echo ' class="current"'; ?>><?php _e( 'Add new', 'wpcf7' ); ?></a></li>
	<?php endif; ?>
	</ul>
...
<form method="post" action="<?php echo $base_url . '?page=' . $page . '&contactform=' . $current; ?>" id="wpcf7-admin-form-element">
	...
	<thead><tr><th scope="col" colspan="2"><?php _e( 'Form', 'wpcf7' ); ?></th></tr></thead>

	<tbody>
	<tr>

	<td scope="col" style="width: 50%;">
	<div><textarea id="wpcf7-form" name="wpcf7-form" cols="100" rows="20"><?php echo htmlspecialchars( $cf->form ); ?></textarea></div>
	</td>
	...
	<table class="widefat" style="margin-top: 1em;">
	<thead><tr><th scope="col" colspan="2"><?php _e( 'Mail', 'wpcf7' ); ?></th></tr></thead>
	...
	<table class="widefat" style="margin-top: 1em;">
	<thead><tr><th scope="col" colspan="2"><?php _e( 'Mail (2)', 'wpcf7' ); ?></th></tr></thead>
	...
	<table class="widefat" style="margin-top: 1em;">
	<thead><tr><th scope="col"><?php _e( 'Messages', 'wpcf7' ); ?> <span id="message-fields-toggle-switch"></span></th></tr></thead>
	...
	<table class="widefat" style="margin-top: 1em;">
	<thead><tr><th scope="col"><?php _e( 'Additional Settings', 'wpcf7' ); ?> <span id="additional-settings-fields-toggle-switch"></span></th></tr></thead>
