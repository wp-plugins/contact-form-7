...
function wpcf7_tag_generator_submit( $contact_form, $args = '' ) {
	...
	$desc_link = sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( __( 'http://contactform7.com/submit-button/', 'contact-form-7' ) ), esc_html( __( 'Submit Button', 'contact-form-7' ) ) );
